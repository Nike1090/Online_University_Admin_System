...
class SelectedCollegeViewController: UIViewController {
    ...
    @IBAction func DisplayProgramView(_ sender: UIButton) {
        // Check if a college is selected
               ...
               // Retrieve programs associated with the selected college
               let programs = DatabaseManager.shared.retrievePrograms().filter { $0.college_Id == selectedCollege.college_Id }
