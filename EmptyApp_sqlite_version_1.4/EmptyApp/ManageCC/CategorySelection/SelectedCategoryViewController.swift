...
class SelectedCategoryViewController: UIViewController {
    ...
    @IBAction func DisplayCourseView(_ sender: UIButton) {
        ...
        // Retrieve courses associated with the selected category
        let courses = DatabaseManager.shared.retrieveCourses().filter { $0.category_Id == selectedCategory.category_Id }
